...
`,
reviewQACode: `<h3><u>Review QA Code</u></h3>
<p>One of the following QA Codes should be assigned during review. These Codes may or may not be the same as Pool Status Code.</p>
<ul>
...
<li>NOT POOL- (Location holds a feature that is not a vernal pool). Assigned when a field investigation and QA review determined the site was not a classic vernal pool, even if it had amphibian breeding habitat and indicator species, such as a seepage wetland.
</li>
...
<li>ERROR- (Data entry error). Assigned when QA review is unable to determine the appropriate code from the list above. Typically used with incomplete or very inconsistent entries without sufficient explanation
</li>
</ul>
`,
